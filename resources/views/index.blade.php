...
<a href="/cdn-cgi/l/email-protection#81f2f4f1f1eef3f5c1e2eeedeef3ede8e3afe2eeec"><span class="lnr lnr-envelope"></span> <span class="text"><span class="text"><span class="__cf_email__" data-cfemail="71020401011e030531121e1d1e031d18135f121e1c">[email&#160;protected]</span></span></span></a>
...
<input name="name" placeholder="Patient name" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common_input form-control" required type="text">
<input name="email" placeholder="Email address" pattern="[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{1,63}$" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" class="common_input form-control" required type="email">
<input name="name" placeholder="Date of birth" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter your name'" class="common_input form-control" required type="text">
<select class="default-select">
<option data-display="Doctor’s name">Doctor’s name</option>
<option value="1">Rashimul</option>
<option value="2">Shofi</option>
</select>
<input name="subject" placeholder="Appointment date" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Subject'" class="common_input mb-10 form-control" required type="text">
<textarea class="common_textarea form-control" name="message" placeholder="Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Messege'" required></textarea>
</div>
